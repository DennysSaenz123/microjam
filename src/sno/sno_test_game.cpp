 ...
 */
sno::sno_test_game([[maybe_unused]] int completed_games, [[maybe_unused]] const mj::game_data& data) :
    mj::game("sno"),
 ...
 */
mj::game_result sno::sno_test_game::play([[maybe_unused]] const mj::game_data& data)
{
 ...
 */
bool sno::sno_test_game::victory() const {
 ...
 * @param data shared information, such as a rng and number of frames left in the microgame
 */
void sno::sno_test_game::fade_in([[maybe_unused]] const mj::game_data& data)
{
}
 ...
 * @param data shared information, such as a rng and number of frames left in the microgame
 */
void sno::sno_test_game::fade_out([[maybe_unused]] const mj::game_data& data)
{
}
